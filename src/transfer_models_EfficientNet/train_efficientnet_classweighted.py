...
MODEL_NAME = "efficientnet_classweighted"
...
def calculate_class_weights(device):
    ...
    Minority classes will receive larger weights.
    """
...
def save_training_curves(history):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("EfficientNet-B0 Weighted Loss Curve")
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / "efficientnet_classweighted_loss_curve.png", dpi=300)
    plt.close()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title("EfficientNet-B0 Weighted Accuracy Curve")
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / "efficientnet_classweighted_accuracy_curve.png", dpi=300)
    plt.close()
...
def main():
    ...
    print("=" * 50)
    print("Training EfficientNet-B0 with Class-weighted CrossEntropyLoss")
    print("=" * 50)
    ...
    best_model_path = MODEL_DIR / "efficientnet_classweighted_best.pth"
    ...
    history_path = RESULT_DIR / "efficientnet_classweighted_training_history.csv"
    ...
    summary_path = RESULT_DIR / "efficientnet_classweighted_training_summary.csv"
    summary_df.to_csv(summary_path, index=False)

    print("\n" + "=" * 50)
    print("EfficientNet-B0 weighted loss training completed")
    print("=" * 50)
