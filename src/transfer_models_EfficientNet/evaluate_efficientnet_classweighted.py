...
def save_confusion_matrix(cm, class_names, output_path):
    ...
    plt.title("EfficientNet-B0 Class-weighted Loss Confusion Matrix")
    plt.colorbar()
...
def main():
    ...
    print("=" * 50)
    print("Evaluating EfficientNet-B0 Class-weighted Loss Model on Test Set")
    print("=" * 50)
    ...
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            "Please run train_efficientnet_classweighted.py first."
        )
    ...
    overall_path = RESULT_DIR / "efficientnet_classweighted_test_metrics.csv"
    overall_df.to_csv(overall_path, index=False)

    per_class_path = RESULT_DIR / "efficientnet_classweighted_per_class_metrics.csv"
    ...
    predictions_path = RESULT_DIR / "efficientnet_classweighted_test_predictions.csv"
    ...
    cm_csv_path = RESULT_DIR / "efficientnet_classweighted_confusion_matrix.csv"
    cm_df.to_csv(cm_csv_path)

    cm_fig_path = FIGURE_DIR / "efficientnet_classweighted_confusion_matrix.png"
