...
def main():
    ...
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            "Please run train_efficientnet.py first."
        )

    # pretrained=False here avoids downloading weights again.
    # The trained weights are loaded from efficientnet_best.pth.
    ...
    overall_path = RESULT_DIR / "efficientnet_test_metrics.csv"
    overall_df.to_csv(overall_path, index=False)

    per_class_path = RESULT_DIR / "efficientnet_per_class_metrics.csv"
    ...
    predictions_path = RESULT_DIR / "efficientnet_test_predictions.csv"
    ...
    cm_csv_path = RESULT_DIR / "efficientnet_confusion_matrix.csv"
    cm_df.to_csv(cm_csv_path)

    cm_fig_path = FIGURE_DIR / "efficientnet_confusion_matrix.png"
