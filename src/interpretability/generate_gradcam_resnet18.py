...
from transfer_models.resnet18_model import get_resnet18
...
MODEL_VARIANTS = {
    "standard": {
        ...
        "display_name": "ResNet18 + Standard CE",
    },
    "classweighted": {
        "model_path": MODEL_DIR / "resnet18_classweighted_best.pth",
        "output_prefix": "resnet18_classweighted",
        "display_name": "ResNet18 + Class-weighted CE",
    },
    "ordinal": {
        "model_path": MODEL_DIR / "resnet18_ordinal_best.pth",
        "output_prefix": "resnet18_ordinal",
        "display_name": "ResNet18 + Ordinal-aware Loss",
    },
}
...
def get_eval_transform():
    """
    Use ImageNet normalization because ResNet18 is pretrained on ImageNet.
    """
...
def main():
    ...
    parser.add_argument(
        ...
        help="Which ResNet18 model variant to visualize."
    )
