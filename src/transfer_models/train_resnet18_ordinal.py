...
def save_training_curves(history):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("ResNet18 Ordinal-aware Loss Curve")
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / "resnet18_ordinal_loss_curve.png", dpi=300)
    plt.close()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.title("ResNet18 Ordinal-aware Accuracy Curve")
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / "resnet18_ordinal_accuracy_curve.png", dpi=300)
    plt.close()
...
def main():
    ...
    print("=" * 50)
    print("Training ResNet18 with Ordinal-aware Weighted Loss")
    print("=" * 50)
    ...
    best_model_path = MODEL_DIR / "resnet18_ordinal_best.pth"
    ...
    history_path = RESULT_DIR / "resnet18_ordinal_training_history.csv"
    ...
    summary_path = RESULT_DIR / "resnet18_ordinal_training_summary.csv"
    summary_df.to_csv(summary_path, index=False)

    print("\n" + "=" * 50)
    print("ResNet18 ordinal-aware loss training completed")
    print("=" * 50)
