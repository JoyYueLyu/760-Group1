...
def predict(model, data_loader, device):
    """
    Run prediction on a dataloader.
    """
    model.eval()
...
def main():
    ...
    overall_path = RESULT_DIR / "baseline_test_metrics.csv"
    overall_df.to_csv(overall_path, index=False)

    # Save per-class metrics
    per_class_path = RESULT_DIR / "baseline_per_class_metrics.csv"
    ...
    cm_csv_path = RESULT_DIR / "baseline_confusion_matrix.csv"
    cm_df.to_csv(cm_csv_path)

    # Save confusion matrix figure
    cm_fig_path = FIGURE_DIR / "baseline_confusion_matrix.png"
