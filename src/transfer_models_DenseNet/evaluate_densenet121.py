...
def main():
    ...
    if not model_path.exists():
        raise FileNotFoundError(
            ...
            "Please run train_densenet121.py first."
        )
    ...
    overall_path = RESULT_DIR / "densenet121_test_metrics.csv"
    overall_df.to_csv(overall_path, index=False)

    per_class_path = RESULT_DIR / "densenet121_per_class_metrics.csv"
    ...
    predictions_path = RESULT_DIR / "densenet121_test_predictions.csv"
    ...
    cm_csv_path = RESULT_DIR / "densenet121_confusion_matrix.csv"
    cm_df.to_csv(cm_csv_path)

    cm_fig_path = FIGURE_DIR / "densenet121_confusion_matrix.png"
