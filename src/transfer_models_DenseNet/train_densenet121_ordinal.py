...
def save_training_curves(history):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / "densenet121_ordinal_loss_curve.png", dpi=300)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(FIGURE_DIR / "densenet121_ordinal_accuracy_curve.png", dpi=300)
    plt.close()
...
def main():
    ...
    print("=" * 50)
    print("Training DenseNet121 with Ordinal-aware Weighted Loss")
    print("=" * 50)
    ...
    best_model_path = MODEL_DIR / "densenet121_ordinal_best.pth"
    ...
    history_path = RESULT_DIR / "densenet121_ordinal_training_history.csv"
    ...
    summary_path = RESULT_DIR / "densenet121_ordinal_training_summary.csv"
    summary_df.to_csv(summary_path, index=False)

    print("\n" + "=" * 50)
    print("DenseNet121 ordinal-aware loss training completed")
    print("=" * 50)
